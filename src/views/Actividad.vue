  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-principal.color-acento-contenido
        .titulo-principal__numero
          span
            i.puzzle-piece.fas.fa-puzzle-piece
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      .col-6.col-md-4.col-lg-3.mb-4.mb-md-0
        .tarjeta.h-100.d-flex.align-items-center.p-4
          figure
            img(src="@/assets/curso/temas/seleccion-multiple.png", alt="Texto que describa la imagen")
      .col-12.col-md-8.col-lg-9
        ...
        .tarjeta.actividad.p-3
          .row.justify-content-around.align-items-center            
            ...
            .col-auto
              a.boton.boton--b(:href="obtenerLink('/actividades/CF14_228125Actividad_didáctica/story.html')" target="_blank")
                span Realizar
